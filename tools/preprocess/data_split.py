...
def data_split(args):
    ...
    df_name = args.save_name_train if args.save_name_train else 'train.csv'
    ...
    df_name = args.save_name_test if args.save_name_test else 'test.csv'
    save_path = os.path.join(args.dataset_root_path, df_name)
...
def main():
    ...
    parser.add_argument('--save_name_train', type=str, default=None)
    parser.add_argument('--save_name_test', type=str, default=None)
