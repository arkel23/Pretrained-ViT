...
from custom_datasets import CUB, NABirds, Aircraft, Cars, Dogs, Pets, Flowers, Food, INat2017
...
def make_df_from_dataset(args):
    ...
    elif args.dataset_name == 'inat2017':
        base_folder = '.'
        dataset_train = INat2017(root=args.dataset_root_path, train=True, download=True)
        dataset_test = INat2017(root=args.dataset_root_path, train=False, download=True)
    else:
